...
{
    CENTER_LINE_1(new Line_Element().withStartPoint(0,0).withEndPoint(0, 10)),
    CENTER_LINE_2(new Line_Element().withStartPoint(0,0).withEndPoint(0, 15)),
    CENTER_LINE_3(new Line_Element().withStartPoint(0,0).withEndPoint(0,20)),
    ...
    HEAD_ROOF(new Line_Element().withStartPoint(10,20).withEndPoint(0,30), new Line_Element().withStartPoint(-10,20).withEndPoint(0,30)),
